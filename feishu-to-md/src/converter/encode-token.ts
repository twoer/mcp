...
function i(e: number, t: number) {
  var n = (65535 & e) + (65535 & t);
  return (e >> 16) + (t >> 16) + (n >> 16) << 16 | 65535 & n
}

function a(e: number, t: number, n: number, r: number, o: number, a: number) {
  return i((s = i(i(t, e), i(r, a))) << (c = o) | s >>> 32 - c, n);
  var s: number, c: number
}

function s(e: number, t: number, n: number, r: number, o: number, i: number, s: number) {
  return a(t & n | ~t & r, e, t, o, i, s)
}

function c(e: number, t: number, n: number, r: number, o: number, i: number, s: number) {
  return a(t & r | n & ~r, e, t, o, i, s)
}

function u(e: number, t: number, n: number, r: number, o: number, i: number, s: number) {
  return a(t ^ n ^ r, e, t, o, i, s)
}

function l(e: number, t: number, n: number, r: number, o: number, i: number, s: number) {
  return a(n ^ (t | ~r), e, t, o, i, s)
}

function d(e: number[], t: number) {
  var n, r, o, a, d;
  e[t >> 5] |= 128 << t % 32,
    e[14 + (t + 64 >>> 9 << 4)] = t;
  var _ = 1732584193
...
export const encodeToken = function (e: string) {
  const t = Math.round((new Date).getTime() / 1e3)
    , n = t + 3600
    , r = "".concat(String(t), ":").concat(String(n))
    , i = "Token:".concat(e)
    , s = seed(32)
