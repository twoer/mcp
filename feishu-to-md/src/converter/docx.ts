...
import { toBlob as svgToBlob, OneHundred } from '../common/svg.js'
import { compare, isDefined } from '../common/utils.js'
import { imageDataToBlob } from '../common/image.js'
import { waitForFunction, Second } from '../common/time.js'
...
import { PageMain, User, isDoc, isDocx } from './env.js'
import {
  isBlockquoteContent,
  isParent,
  isPhrasingContent,
...
import { resolveFileDownloadUrl } from './file.js'
...
export class Docx {
  ...
  get rootBlock(): PageBlock | null {
    ...
    return PageMain.blockManager.rootBlockModel as any
  }
